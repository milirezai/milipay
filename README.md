...
$response->response()->getCodeMessage(); // با هر پاسخ به درگاه، کدی تولید و برای ما ارسال می‌شود که نشان‌دهنده وضعیت و نتیجه است، با استفاده از این روش می توان به معنای این کد پی برد.
