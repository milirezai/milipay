...
این کلای شامل متد های  gate() و with() است


متد gate():


به صورت خودکار درگاه پیش فرضی که در فایل کانفیک نوشته شده را انتخاب می کند و برای پرداخت و بقیه مراحل از اون درگاه استفاده می کنه


متد with():

اگر قصد تغییر درگاه پیش فرض رو دارید و نمی خواهید تغییری توی فایل کانفیگ انجام بدید می تونید ار این متد استفاده کنید و اسم در گاه رو بهش بدید ولی حتما در گاه باید جزو درگاه های ساپورت شده ی ما باشه تا برنامه به درستی کار کنه
